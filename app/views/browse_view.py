                        ...
                        ft.Container(
                            ...
                            content=ft.Column(
                                ...
                                controls=[
                                    ...
                                    ft.Row([
                                        ft.Icon(ft.Icons.LOCATION_ON, size=16, color="#666"),
                                        ft.Text(location, size=14, color="#666", max_lines=1)
                                    ], spacing=4),
                        ...
                        content=ft.Row(
                            ...
                            content=ft.Column(
                                ...
                                controls=[
                                    ...
                                    ft.Text("No properties found", size=20, color="#666", weight=ft.FontWeight.BOLD),
